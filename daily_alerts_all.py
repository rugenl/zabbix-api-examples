...
csvfile = open("alerts.csv", "w")
csv = csv.writer(csvfile)
csv.writerow( ( "Date - Time", "User Name", "Media Type", "SendTo", "Subject / Command", "Status", "Error", \
    "Acknowledged", "Ack By", "Ack Time", "Ack Message" ) )
...
for alert in alerts:
    ...
    if sendto == 'EventTranslator':
        ...
        csv.writerow(  (messageTime, user_fullname, mediadescription, sendto, subject, \
                     status, alerterror, acknowledged, ackBy, ackTime, ackMsg) )
